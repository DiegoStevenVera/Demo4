...
urlpatterns = [
    ...
    path("userhasmovie/", view=User_has_MovieListView.as_view(), name="listar y crear las compras"),
    path("userhasmovie/<int:pk>/", view=User_has_MovieDetailView.as_view(), name="listar una compra")
]